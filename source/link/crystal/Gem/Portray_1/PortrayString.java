    ...
    implements          Inspectable<Inspection>//,
{
    ...
    //  Abstract <me>
    //
    public abstract void                portray_string(final Capital_StringBuilder builder, final String s);
    ...
    {
        trace("Dump of PortrayString");

        trace("   0:  {p}", PortrayString.portray_string__invalid);
        trace("  KA:  {p}", PortrayString.backslash_with_apostrophe);
        trace("  KQ:  {p}", PortrayString.backslash_with_quotation_mark);
        trace("  KC:  {p}", PortrayString.backslash_with_triple_apostrophe);
        trace("  KS:  {p}", PortrayString.backslash_with_triple_quotation_mark);
        trace("  PA:  {p}", PortrayString.normal_with_apostrophe);
        trace("  PQ:  {p}", PortrayString.normal_with_quotation_mark);
        trace("  PC:  {p}", PortrayString.normal_with_triple_apostrophe);
        trace("  PS:  {p}", PortrayString.normal_with_triple_quotation_mark);
        trace("  RA:  {p}", PortrayString.raw_with_apostrophe);
        trace("  RQ:  {p}", PortrayString.raw_with_quotation_mark);
        trace("  RC:  {p}", PortrayString.raw_with_triple_apostrophe);
        trace("  RS:  {p}", PortrayString.raw_with_triple_quotation_mark);

        trace("End of dump of PortrayString");
    }
}
    ...
    implements          Inspectable       <Inspection>//,
{
    ...
    //
    public final void                   portray_string(final Capital_StringBuilder builder, final String s)
    {
