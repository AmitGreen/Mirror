    ...
    implements      Inspectable       <Inspection>//,
{
    ...
    {
        trace("===   Unit Test:  Portray String   ===");
        ...
        for (i = 0; i < portray_string_total; i ++) {
            ...
            if ( ! raw_actual.equals(raw_expected)) {
                trace("portray_raw_string({p})", s);
                trace("  actual:   {}", raw_actual);
                trace("  expected: {}", raw_expected);
            ...
            if ( ! python_actual.equals(python_expected)) {
                trace("portray_python_string({p})", s);
                trace("  actual:   {}", python_actual);
                trace("  expected: {}", python_expected);
        ...
        if (i < portray_string_total) {
            trace("INCOMPLETE:   Unit Test:  Portray String");
        } else {
            trace("PASSED:  Portray String");
        }
