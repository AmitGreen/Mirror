...
public final class  Capital_StringBuilder
    extends         Inspectable_Object<Inspection>
//  extends         Object
    implements      Inspectable       <Inspection>//,
{
    private static final Inspection     inspection = Inspection.create("Capital_StringBuilder");
    ...
    //
    private                             Capital_StringBuilder(final Zone z, final StringBuilder builder)
    {
        this.z        = z;
    ...
    public static final Capital_StringBuilder   create__ALLY__Zone(final Zone z)
    {
        final StringBuilder             builder = new StringBuilder();

        return new Capital_StringBuilder(z, builder);
    }


    public final Capital_StringBuilder  recycle()
    {
    ...
    public final void                   portray(final Capital_StringBuilder builder)
    {
        ...
        if (this == builder) {
            //
            //  NOTE:
            //      Special case, we are using this Capital_StringBuilder to show itself ...
            //
            builder.augment("<Capital_StringBuilder builder<{} of {}>; MYSELF>", client.length(), client.capacity());
            return;
        }

        builder.augment("<Capital_StringBuilder builder<{} of {}; {p}>>",
                        client.length(),
                        client.capacity(),
                        client.toString());
    }
...
//  }
    ...
    public final String                 finish_AND_recycle()
    {
        ...
        this.z.recycle__StringBuilder__ALLY__Capital_StringBuilder(this);
    ...
    public final void                   format(final Object v)
    {
        ...
        if (v_class == Capital_Global.Integer$class) {
            this.builder.append((Integer) v);
            return;
        }

        if (v_class == Capital_Global.String$class) {
            this.builder.append((String) v);
            return;
        }

        if (v_class == Capital_Global.Thread$class) {
            this.builder.append("<").append(v.toString()).append(">");
            return;
        }

        if (v_class == Capital_Global.Capital_StringBuilder$array$class)
        {
            final Capital_StringBuilder[]   v2 = (Capital_StringBuilder[]) v;

            this.augment("<Capital_StringBuilder size{p}>", v2.length);
            return;
        }
