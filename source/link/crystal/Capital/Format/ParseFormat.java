...
import link.crystal.Capital.Core.ArrayFunctions;
...
import link.crystal.Capital.Format.MessageFormatter_1__Prefix;
import link.crystal.Capital.Format.MessageFormatter_2;
import link.crystal.Capital.Format.MessageFormatter_3;
import link.crystal.Capital.Format.MessageFormatter_4;
import link.crystal.Capital.Format.MessageFormatter_5;
import link.crystal.Capital.Format.MessageFormatter_Many;
    ...
    implements      Inspectable<Inspection>//,
{
    ...
    private /*:*/ Capital_StringBuilder builder;
    ...
    private final void                  examine_missing()
    {
        ...
        final Capital_StringBuilder     builder = this.summon_builder();
    ...
    private final MessageFormattable<?>     parse_format__work()
    {
        ...
        /*:*/ Capital_StringBuilder     builder           = null;
        ...
        for (;;) {
            ...
            if (braces_matcher.start(3) != -1) {
                this.append_segment(Capital_Global.conjure_MethodNameSegmentFormatter());
            } else {
        ...
        if (false) {
            final Capital_StringBuilder b2 = z.summon_StringBuilder();
            ...
            for (/*:*/ int              i = 0; i < segment_total; i ++) {
                ...
                final Capital_StringBuilder b3      = z.summon_StringBuilder();
    ...
    private final Capital_StringBuilder summon_builder()
    {
        /*:*/ Capital_StringBuilder     builder = this.builder;
